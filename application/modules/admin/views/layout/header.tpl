...
<ul class="nav navbar-nav navbar-left">
    <li>
        <a class="fw700 fs14" target="_blank" href="http://localhost/codeigniter-cms/"><span class="octicon octicon-screen-full fs18 mr5"></span> Xem website</a>
    </li>
</ul>
...
<ul class="nav navbar-nav navbar-right">
        ...
        <ul class="dropdown-menu dropdown-hover dropdown-persist pn w350 bg-white animated animated-shorter fadeIn" role="menu">
            ...
            <li class="p10 br-t item-4">
                <div class="text-white p10 fw600 text-center">
                    <a style="padding:8px 14px;font-size: 16px;" class="bg-info light" href="http://ivoc.vn" title="Nâng cấp">Nâng cấp</a>
                </div>
            </li>
        </ul>
    </li>
    ...
    <li class="dropdown">
        <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> 
            <img src="http://localhost/codeigniter-cms/public/img/avatar.jpg" alt="avatar" width="30" height="30" class="br3 mr15">
            <span>Xin chào: Nguyễn</span>
            <span class="caret caret-tp hidden-xs"></span>
        </a>
        <ul class="dropdown-menu dropdown-persist pn w250 bg-white" role="menu">
            <li class="br-t of-h">
                <a href="http://localhost/codeigniter-cms/public/accout" class="fw600 p12 animated animated-short fadeInDown">
                    <span class="fa fa-lock pr5"></span> Thay đổi mật khẩu 
                </a>
            </li>
            <li class="br-t of-h">
                <a href="http://localhost/codeigniter-cms/public/logout" class="fw600 p12 animated animated-short fadeInDown">
